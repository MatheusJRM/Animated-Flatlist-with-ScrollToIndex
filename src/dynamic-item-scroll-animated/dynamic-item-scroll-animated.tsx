...
export function DynamicItemScrollAnimated() {
  ...
  React.useEffect(() => {
    ref.current?.scrollToIndex({
      index: index,
      animated: true,
      viewOffset: viewPosition === 0.5 || viewPosition === 1 ? 0 : _spacing, // espaçamento para não ficar colado no canto da tela
      viewPosition: viewPosition, // porcentagem do vewport começando da esquerda
    });
  }, [index, viewPosition]);
